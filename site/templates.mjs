...
export function about() {
  ...
  return `<section class="about-page"><div class="section-head work-head" data-motion="sectionHead"><div><h1 class="work-heading">About</h1></div><p><em>${esc(SITE.title)} based in ${esc(SITE.location)} — running ${esc(SITE.company)}. Software, cloud, networking, and open source.</em></p><div class="detail-meta">${detailChip(esc(SITE.location))}${detailChip(esc(SITE.company))}<a class="detail-chip" href="mailto:${esc(SITE.email)}">${esc(SITE.email)}</a></div></div>
<section class="about-chapter"><h2 class="about-chapter-title" data-motion="sectionHead">What I Do</h2><ol class="work-list about-list">${cats.map(([k, label], i) => `<li class="work-row about-row" data-motion="card" data-motion-delay="${i * 60}"><span class="work-row-index">${String(i + 1).padStart(2, '0')}</span><span class="work-row-main"><h3 class="work-row-title post-row-title">${esc(label)}</h3><p class="work-row-desc">${esc(catDesc(k))}</p></span></li>`).join('')}</ol></section>
